"""
benchmark_suite_v21.py — Suite de benchmark para v21 (Aceptación Discreta + Función Subrogada)
"""
...
from seismic_descent_v21 import seismic_swarm
...
def run_single_benchmark(func_config, dims, n_trials, eval_budget_base):
    ...
    # Usamos los mismos parámetros universales de la v20 para comparar
    UNIVERSAL_DT = 0.2         
    UNIVERSAL_NOISE_AMP = 0.5  
    DT_CYCLES_MULT = 5.0       
